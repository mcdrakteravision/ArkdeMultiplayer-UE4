...
bool UACMT_PlayMontageAndWaitForEvent::StopPlayingMontage()
{
	...
	UAnimInstance* animInstace = actorInfo->GetAnimInstance();
	...
	if (AbilitySystemComponent && Ability)
	{
		...
		{
			FAnimMontageInstance* montageInstance = animInstace->GetActiveInstanceForMontage(MontageToPlay);
			if (montageInstance)
			{
...
//===============================================================================================================
void UACMT_PlayMontageAndWaitForEvent::OnGameplayEvent(FGameplayTag EventTag, const FGameplayEventData* Payload)
{
	if (ShouldBroadcastAbilityTaskDelegates())
	{
